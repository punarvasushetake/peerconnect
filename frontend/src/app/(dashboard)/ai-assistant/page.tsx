    ...
    <div className="space-y-6">
      <Card className="p-6">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Summarize content, ask AI questions, search repository knowledge, and generate quizzes.
        </p>
      </Card>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <Card className="p-6 space-y-3">
          <h2 className="text-lg font-semibold text-slate-900">AI Search & Answer</h2>
          <div className="flex gap-2">
            <Input
              placeholder="Ask anything, or search repository knowledge..."
              value={searchQuery}
          ...
          <div className="space-y-2">
            ...
            {!searchLoading && searchQuery && searchResults.length === 0 && (
              <EmptyState
                ...
                description="The answer above can still come from the AI model when local resources do not match."
              />
            )}
          </div>
        </Card>
